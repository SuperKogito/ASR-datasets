...
Automatic Speech Recognition Datasets for the Italian language.

.. csv-filter:: ASR-Datasets
   :file: csv/asr-datasets-italian.csv
   :header-rows: 1
   :class: datatable
...
List of corpora for the Italian language.

.. csv-filter:: Corpora
  :file: csv/corpora-italian.csv
  :header-rows: 1
  :class: datatable
