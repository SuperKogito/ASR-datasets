...
Automatic Speech Recognition Datasets for the Spanish language.

.. csv-filter:: ASR-Datasets
   :file: csv/asr-datasets-spanish.csv
   :header-rows: 1
   :class: datatable
...
List of corpora for the Spanish language.

.. csv-filter:: Corpora
  :file: csv/corpora-spanish.csv
  :header-rows: 1
  :class: datatable
...
.. _`120h Spanish Speech`: https://www.kaggle.com/datasets/carlfm01/120h-spanish-speech
