...
Automatic Speech Recognition Datasets for the Polish language.

.. csv-filter:: ASR-Datasets
   :file: csv/asr-datasets-polish.csv
   :header-rows: 1
   :class: datatable
...
List of corpora for the Polish language.

.. csv-filter:: Corpora
  :file: csv/corpora-polish.csv
  :header-rows: 1
  :class: datatable
